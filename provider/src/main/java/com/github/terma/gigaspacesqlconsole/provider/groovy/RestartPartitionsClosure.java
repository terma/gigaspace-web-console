...
public class RestartPartitionsClosure extends Closure {

    private final ExecuteRequest request;

    public RestartPartitionsClosure(final ExecuteRequest request) {
        super(null);
    ...
    public Object call() {
        ...
        try {
            ((JSpaceAdminProxy) gigaSpace.getSpace().getAdmin()).restart();
            gigaSpace.getSpace().getAdmin();
