...
public class GroovyExecuteToCsvServlet extends HttpServlet {
    ...
    protected void doPost(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final GroovyExecuteResponseStream responseStream = new CsvGroovyExecuteResponseStream(writer);

        try {
            CachedProviderResolver.getProvider(req.driver).groovyExecute(req, responseStream);
